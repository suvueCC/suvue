package cn.suvue.common.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.StrUtil;
import cn.suvue.common.config.JwtConfig;
import cn.suvue.common.constant.AuthConst;
import cn.suvue.common.constant.Status;
import cn.suvue.common.exception.SecurityException;
...
public class JwtUtil {
    ...
    public String createJWT(Boolean rememberMe, Long id, String subject, List<String> roles, Collection<? extends GrantedAuthority> authorities) {
        ...
        // 将生成的JWT保存至Redis
        stringRedisTemplate.opsForValue().set(AuthConst.Jwt.REDIS_JWT_KEY_PREFIX + subject, jwt, ttl, TimeUnit.MILLISECONDS);
        return jwt;
    }
    ...
    public Claims parseJWT(String jwt) {
        try {
            ...
            String redisKey = AuthConst.Jwt.REDIS_JWT_KEY_PREFIX + username;
    ...
    public void invalidateJWT(HttpServletRequest request) {
        ...
        // 从redis中清除JWT
        stringRedisTemplate.delete(AuthConst.Jwt.REDIS_JWT_KEY_PREFIX + username);
    }
